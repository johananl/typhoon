...
|---------------|------------------|------------------|--------|
| AWS           | Container/Flatcar Linux  | [aws/container-linux/kubernetes](aws/container-linux/kubernetes) | stable |
| Azure         | Container Linux  | [azure/container-linux/kubernetes](cl/azure.md) | alpha |
| Bare-Metal    | Container/Flatcar Linux  | [bare-metal/container-linux/kubernetes](bare-metal/container-linux/kubernetes) | stable |
